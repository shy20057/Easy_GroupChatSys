...
public enum MessageTypeEnum {
    ...
    CHAT(2, "", "普通聊天消息"),
    GROUP_CREATE(3, "", "群组已经创建好，可以和好友一起聊聊了", "群创建成功"),
    ...
    // 处理GROUP_CREATE这类多参数的构造场景（图片中未显示完整，按枚举定义补充）
    MessageTypeEnum(Integer type, String initMessage, String desc, String extraDesc) {
        this.type = type;
        this.initMessage = initMessage;
        this.desc = desc;
    }
